    ...
    try:
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            for rumor_info in rumor_infos:
                future = executor.submit(parsing_work, cdc, rumor_info)
                works.append(future)
        ...
        logger.info("CDC Crawler start date: {}".format(latest_create_date))
        logger.info("Number of CDC Crawler rumor_infos: {}".format(len(rumor_infos)))
